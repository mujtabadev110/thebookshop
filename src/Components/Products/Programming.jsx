...
<div style={{display: "inline-block" , margin: '1rem' , color: "#444444" }}> <h1 style={ { color: "#008248" ,fontWeight: "bold"} }>Programming</h1> </div>
...

{
            ...
            programmingBook.map((book) => (
                
                <div className="col-md-4 col-sm-6 col-xs-12 ">
                <div key={programmingBook._id} className="card"style={{height: 500}} >
