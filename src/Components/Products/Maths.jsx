...
<div style={{display: "inline-block" , margin: '1rem' , color: "#444444" }}> <h1 style={ { color: "#008248" ,fontWeight: "bold"} }>Mathematics</h1> </div>
</div>
...

{
            ...
            mathsBook.map((book) => (
              ...
              <div key={mathsBook._id} className="card"style={{height: 500}} >
